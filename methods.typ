...
Computed energies via density functional theory are obtained from the Materials Project database, @jain2013CommentaryMaterials which reports both mixed GGA and GGA$+U$ calculations using the scheme from #textcite(<jain2011FormationEnthalpies>),  and when available, R2SCAN computed energies. 
